...
convert -background white -fill black -font /usr/share/fonts/ttf/LiberationMono-Bold.ttf -pointsize 64 label:"TRUCKY" -gravity Center -extent 1872x72 -depth 8 gray:- | /home/root/install/it8951 -d -m 4 /dev/sdb 0 550 1872 72
